...
<center>**À MEDIDA QUE O PROJETO SE ARRASTA, O MEU $\color{red}{\text{GIT COMMIT MESSAGES}}$ FICA MENOS E MENOS INFORMATIVO.**</center>
...
>$\color{red}{\text{PS.}}$ Antes de tudo, [**clique aqui**](https://git-scm.com/downloads) para baixar o GIT, escolha a opção correspondente ao seu **sistema operacional** e no momento da instalação siga as **opções recomendadas** pelo instalador do cliente.
...
* O Git Tower fornece bons infográficos que ilustram como as diferentes partes do fluxo de trabalho do Git se encaixam. [Git workflow](https://www.git-tower.com/blog/workflow-of-git)
* Um excelente (mas talvez muito abrangente para iniciantes) é o [Pro Git Book](https://git-scm.com/book/en/v2). Este capítulo é ótimo para aprender como usar o [GitHub](https://git-scm.com/book/en/v2/GitHub-Contributing-to-a-Project) para contribuir com um projeto.
